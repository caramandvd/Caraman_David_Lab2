...
namespace Caraman_David_Lab2.Data
{
    public class Caraman_David_Lab2Context : DbContext
    {
        ...
        public DbSet<Caraman_David_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Caraman_David_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Caraman_David_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
