...
namespace Caraman_David_Lab2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            Caraman_David_Lab2.Data.Caraman_David_Lab2Context context)
        {
           ...
           Input.Password);
            ...
            if (result.Succeeded)
            {
               ...
               var callbackUrl = Url.Page("/Account/ConfirmEmail",pageHandler: null, values: new
               {
                ...
                await _emailSender.SendEmailAsync(Input.Email, "your email",

                $"Please confirm your account by <href = '{HtmlEncoder.Default.Encode(callbackUrl)}' > clicking here </ a >.");
